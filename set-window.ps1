...
#Get-Process powershell | Set-Window -X 2040 -Y 142 -Passthru
Write-verbose -message "ProcessWerte vorher auslesen" -verbose
$ProcessWerte1=Get-Process powershell_ise | Set-Window -Passthru
$ProcessWerte1
start-sleep -Seconds 5
Write-verbose -message "Setze Bild von Prozess auf Vollbild" -verbose
start-sleep -Seconds 5
Get-Process powershell_ise | Set-Window -X 0 -Y 0 -Width 1382 -Height 754
Write-verbose -message "ProcessWerte nachher auslesen" -verbose
$ProcessWerte2=Get-Process powershell_ise | Set-Window -Passthru
$ProcessWerte2
